...
#predfile<-'/group/im-lab/nas40t2/smozaffari/Elastic_Net/GTEx_pilot_predicted' ##on tarbell
predfile<-'/Users/heather/Dropbox/PrediXcan/GTEx/GTEx_pilot_predicted_from_DGN_elasticNet_alpha0.5'

#obsdir<-'/group/im-lab/nas40t2/nknoblauch/predixmod_Inputs/peer_factors/' ##on tarbell
obsdir<-'/Users/heather/Dropbox/PrediXcan/GTEx/gtex-exp/'

pilotfile<-'/Users/heather/Dropbox/PrediXcan/GTEx/pilot-GTEx.SubjectDS.v10.1.DRAFT.txt'
...
tpred<-t(pred[,-1])
predid<-scan('/Users/heather/Dropbox/PrediXcan/GTEx/GTEx_pilot_predicted_from_DGN_elasticNet_alpha0.5_ID.list','character')
rownames(tpred)<-predid

tissuelist<-scan('/Users/heather/Dropbox/PrediXcan/GTEx/GTEx_nine_tissues','character')
